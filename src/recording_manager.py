...
class RecordingManager:
    ...
    def stop_recording(self):
        ...
        try:
            ...
            self.is_paused = False
            console.print(
                f"[{config.display.colors.success}]Recording saved to: {self.current_recording}[/]"
            )
            ...
            try:
                console.print(
                    f"[yellow]Using Whisper model: {config.transcription.whisper.model}[/yellow]"
                )
                ...
                console.print(
                    "[green]Transcription complete! Displaying results:[/green]"
                )
            ...
            console.print(
                f"[{config.display.colors.error}]Error stopping recording: {str(e)}[/]"
            )
